...
tasks = {
    ...
    # train ZO optimizer (both UpdateRNN and QueryRNN) for FashionMNIST attack with Prop
    'VarReducedZOL2L-Attack-FMNIST-Prop': {
        'nn_optimizer': nn_optimizer.zoopt.VarReducedZOOptimizerProp,
        'optimizee': optimizee.mnist.FMnistAttack,
        'batch_size': 1,
        'test_batch_size': 1,
        'lr': 0.005,
        ...
        'tests': {
            ...
            'n_steps': 200,
            'test_batch_size': 1,
            'nn_opt': nn_optimizer.zoopt.VarReducedZOOptimizerProp,
            'base_opt': nn_optimizer.basezoopt.BaseZOOptimizer,
            'base_lr': 4,
            'sign_opt': nn_optimizer.basezoopt.SignZOOptimizer,
            'sign_lr': 8,
    ...
    # train ZO optimizer (both UpdateRNN and QueryRNN) for CIFAR10 attack
    'VarReducedZOL2L-Attack-CIFAR10-Prop': {
        'nn_optimizer': nn_optimizer.zoopt.VarReducedZOOptimizerProp,
        'optimizee': optimizee.cifar.CIFAR10Attack,
        'batch_size': 1,
        'test_batch_size': 1,
